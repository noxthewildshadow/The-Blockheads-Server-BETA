...
show_usage() {
    ...
    echo -e " ${CYAN}• Centralized players.log management${NC}"
    echo -e " ${CYAN}• Automated rank synchronization${NC}"
    echo -e " ${CYAN}• Password system with IP verification${NC}"
    echo -e " ${CYAN}• Real-time command monitoring${NC}"
}
